...
* 2026-09-14 version 3.7.0
    - 特定の LZH ファイルを DMG 形式と誤判定し、解凍に失敗する不具合を修正
    - 長いパスへの解凍時に ZoneID の伝搬処理でエラーが発生し、解凍処理が異常終了する不具合を修正
    - 7-Zip を 26.03 相当に更新
* 2026-07-06 version 3.6.1
    - 7-Zip を 26.02 相当に更新
* 2026-06-16 version 3.6.0
    - 解凍先フォルダーのアクセス許可を継承するオプションを追加
    - 7-Zip を 26.01 相当に更新
